...
// Narrative nav — follows the landing page story arc in order
const navLinks = [
  ...
  return (
    <>
      ...
      >
        <div className="max-w-6xl mx-auto px-4 sm:px-6 flex items-center justify-between">
          ...
          <a href="#" className="flex items-center gap-2.5">
            <span className="text-xl sm:text-2xl font-arabic font-bold" style={{ color: 'var(--accent)' }}>
              نفير
            </span>
            <div className="hidden sm:block w-px h-4" style={{ background: 'var(--border-mid)' }} />
            <span className="hidden sm:block text-xs font-mono tracking-wider" style={{ color: 'var(--text-muted)' }}>
              بوابة المساهمين
            </span>
          </a>

          {/* Desktop nav links — story-ordered */}
      ...
      {menuOpen && (
        ...
        >
          <p className="text-xs font-mono tracking-widest uppercase mb-3 px-2" style={{ color: 'var(--text-muted)' }}>
            اقرأ القصة ↓
          </p>
          ...
          <div className="flex items-center gap-2.5" style={{ borderTop: '1px solid var(--border-subtle)', paddingTop: '1rem' }}>
            <a
              href="/signin"
              onClick={() => setMenuOpen(false)}
              className="flex-1 py-2.5 text-center text-sm rounded-xl transition-colors"
            ...
            <a
              href="/prejoin"
              onClick={() => setMenuOpen(false)}
              className="flex-1 py-2.5 text-center text-sm font-bold rounded-xl"
              style={{ background: 'var(--accent)', color: '#0e0c09' }}
            >
              انضم للنفير
            </a>
