...
export const DEMO_LESSON_PHYSICS = {
  ...
  checkpoint: {
    ...
    correctIndex: 2,
    explanation:  'باستخدام المعادلة الأساسية: ق = ك × ت، نعوّض ق = ٢ × ٥ = ١٠ نيوتن. الخيار الأول ناتج عن قسمة خاطئة، والثاني عن جمع الأرقام بدل ضربها.',
  },
  ...
  blocks: [
    ...
    },
    {
      ...
      caption: 'مخطط الجسم الحر',
      description:
        'الجسم تؤثر عليه قوة محصّلة نحو اليمين فيتسارع في اتجاهها — التسارع دائماً في اتجاه القوة المحصّلة.',
      color: '#4A90D9',
      icon: 'diagram',
    },
    {
    ...
    },
    {
      id: 'b5b',
      type: 'TABLE',
      caption: 'أمثلة مقارنة — ق = ك × ت',
      headers: ['الكتلة (كغ)', 'التسارع (م/ث²)', 'القوة (ن)'],
      rows: [
        ['١', '١٠', '١٠'],
        ['٢', '١٠', '٢٠'],
        ['٤', '٣',  '١٢'],
    ...
    },
    {
      ...
      caption: 'تأثير القوة على التسارع',
      description:
        'كلما ضاعفت القوة على نفس الكتلة، تضاعف التسارع — والعكس صحيح. هذه هي جوهر القانون الثاني.',
      color: '#4A90D9',
    },
    {
      id: 'b8',
...
export const DEMO_LESSON_HISTORY = {
  ...
  checkpoint: {
    ...
    correctIndex: 2,
    explanation:  'أعلن المهدي ثورته من جزيرة أبا على النيل الأبيض — ليس الخرطوم (سقطت لاحقاً ١٨٨٥)، وليس الأبيض (فُتحت ١٨٨٣)، وليس أم درمان (موقع المعركة الأخيرة ١٨٩٨).',
  },
  ...
  blocks: [
    ...
    },
    {
      id: 'h3b',
      type: 'IMAGE_PLACEHOLDER',
      caption: 'جزيرة أبا — منشأ الثورة',
      description:
        'جزيرة أبا على النيل الأبيض جنوب الخرطوم — المكان الذي أطلق منه المهدي دعوته عام ١٨٨١ وجمع حوله أول الأنصار.',
      color: '#C0392B',
      icon: 'portrait',
    },
    {
    ...
    },
    {
      id: 'h4b',
      type: 'TABLE',
      caption: 'المراحل الزمنية الكبرى',
      headers: ['السنة', 'الحدث', 'النتيجة'],
      rows: [
        ['١٨٨١', 'إعلان المهدية — جزيرة أبا', 'بداية التجمّع'],
        ['١٨٨٣', 'معركة شيكان', 'هزيمة هيكس باشا'],
        ['١٨٨٥', 'فتح الخرطوم', 'مقتل غردون'],
        ['١٨٩٨', 'معركة أم درمان', 'نهاية المهدية'],
      ],
    },
    {
      id: 'h5',
      type: 'EXAMPLE',
      caption: 'المراحل الزمنية — تفاعلي',
      interactive: true,
      steps: [
        '١٨٨١ — إعلان المهدية في جزيرة أبا والبدء بتجميع الأنصار.',
        '١٨٨٣ — معركة شيكان: هزيمة الجيش المصري بقيادة هيكس باشا.',
        '١٨٨٥ — فتح الخرطوم وسقوط غردون. وفاة المهدي بعد أشهر، خلفه الخليفة عبدالله.',
    ...
    },
    {
      ...
      type: 'TEXT',
      content:
        'أسفر انتصار كيتشنر عن بدء الحكم الثنائي (الإنجليزي المصري) للسودان رسمياً عام ١٨٩٩، مرحلة جديدة ستمتد حتى الاستقلال ١٩٥٦.',
    },
    {
      id: 'h8',
      type: 'TIP',
      content:
        'في الامتحانات: ركّز على التسلسل الزمني والأسباب المباشرة وغير المباشرة. الأسباب الاقتصادية (الضرائب المرهقة) غالباً تُسأل جنباً إلى جنب مع الدينية.',
    },
  ],
};
