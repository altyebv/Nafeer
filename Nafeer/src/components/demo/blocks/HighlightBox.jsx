...
const STYLE_CONFIG = {
  DEFINITION: {
    bg: 'rgba(74,144,217,0.10)', border: 'rgba(74,144,217,0.28)', color: '#4A90D9', label: 'تعريف',
  ...
  WARNING: {
    bg: 'rgba(231,76,60,0.10)', border: 'rgba(231,76,60,0.28)', color: '#E74C3C', label: 'تنبيه',
    icon: <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3Z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>,
  },
  TIP: {
    bg: 'rgba(155,89,182,0.10)', border: 'rgba(155,89,182,0.28)', color: '#9B59B6', label: 'نصيحة',
  ...
  NOTE: {
    bg: 'rgba(255,255,255,0.04)', border: 'rgba(255,255,255,0.10)', color: 'var(--text-muted)', label: 'ملاحظة',
    icon: <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4M12 8h.01"/></svg>,
  },
};
...
export function HighlightBox({ block }) {
  ...
  return (
    <div className="mx-4 my-2 rounded-xl p-3" dir="rtl"
      ...
      <div className="flex items-center gap-1.5 mb-1.5" style={{ color: cfg.color }}>
